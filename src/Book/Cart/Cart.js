    ...
    <div className="position-fixed mx-auto">
      ...
      <Card style={{ width: "18rem" }}>
        <Card.Body>
          <Card.Title>
            ...
            <div id="showData" className="row">
              <div className=" col ">
                {cart.map((partbook) => (
                  <img
                    className="w-25 mb-3 d-flex flex-colum"
                    src={partbook.imageLink}
                    alt=""
                  />
                ))}
              </div>
              <div className="col">
                {cart.map((partbook) => (
                  <li className="mb-1">{partbook.title}</li>
                ))}
              </div>
            </div>
          </Card.Title>
          <button onClick={randomData} className="btn btn-dark my-2">
            Chosse Randomly
          </button>{" "}
          <br />
          {/* <div className='col'>
          ...
          <button onClick={closeAlldata} className="btn btn-dark">
            Close All
          </button>
        </Card.Body>
      </Card>
